...
//    lv_obj_align_to(weather_label, weather_anim, LV_ALIGN_OUT_BOTTOM_MID, 0, 10);
...
void UIWeather::show() {
    auto lay_left = lv_obj_create(lv_scr_act());
    auto lay_right = lv_obj_create(lv_scr_act());
    ...
    lv_obj_t *outside_label = lv_label_create(lv_scr_act());
    ...
    minus_line = lv_line_create(lv_scr_act());
    ...
    temp_range_label = lv_label_create(lv_scr_act());
    ...
    update_info("partly sunny", "weather", 0, 20, 35);

    lv_timer_create(test_cb, 500, this);
