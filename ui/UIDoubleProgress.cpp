...
void UIDoubleProgress::show() {
    ...
    m_bar_2 = lv_bar_create(lv_scr_act());
    ...
    m_status_label_1 = lv_label_create(lv_scr_act());
    ...
    m_status_label_2 = lv_label_create(lv_scr_act());
...
void UIDoubleProgress::update(const char *title, const char *status_1, uint8_t progress_1, const char *status_2,
    ...
    lv_bar_set_value(m_bar_1, progress_1, LV_ANIM_ON);
    ...
    lv_bar_set_value(m_bar_2, progress_2, LV_ANIM_ON);
}
