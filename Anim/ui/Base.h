...
namespace UI {
    ...
    public:
        ...
        RoutableTarget search(index_t index) {
            for (int index_main = 0; index_main < get_main_size(); index_main++) {
                for (int index_sub = 0; index_sub < get_sub_size(index_main); index_sub++) {
                    if (m_map[index_main][index_sub] == index) {
                        return {index, index_main, index_sub};
                    }
                }
            }
            return {UI_NULL, 0, 0};
    ...
    public:
        ...
        virtual void front_input_cb(bool touch);
